                ...
                <table class="table-fixed min-w-full text-sm text-left text-gray-800">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td scope="row" class="px-2 font-medium text-gray-700 whitespace-nowrap">{{ $pass->id }}</td>
                            <td class="px-2">{{ $pass->user->ncard }}</td>
                            <td class="px-2">{{ $pass->user->name }}</td>
                            <td class="px-2">{{ $pass->user->charge->name_charge }}</td>
                            <td class="px-2">{{ $pass->user->dependence->name_dependence }}</td>
                            <td class="px-2">{{ $pass->motive }}</td>
                            <td class="px-2">{{ $pass->place }}</td>
                            <td class="px-2">{{ $pass->time->time_permision }}</td>
                            <td class="px-2">{{ $pass->input }}</td>
                            <td class="px-2">{{ $pass->output }}</td>
                            <td class="px-2">{{ $pass->date }}</td>
                            <td class="px-2">
