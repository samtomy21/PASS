<x-app-layout>
    ...
    <div class="max-w-7xl">
        <form action="charges" method="POST" class="flex mb-4 mx-5 mt-10 rounded">
            @csrf
            <input type="text" name="name_charge" class="rounded border-gray-500 pr-10" placeholder="Nuevo Cargo">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b bg-white-800 border-gray-700">
                    ...
                    <td class=" flex px-auto py-4">
                        <a href="{{ route('charges.edit', $charge) }}" class="bg-blue-800 text-white rounded px-auto py-1 mx-1">Editar</a>
                        <form action="charges/{{ $charge->id }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <input type="submit" class="bg-red-500 text-white rounded px-auto py-1 mx-1" value="Eliminar">
                        </form>
                    </td>
                </tr>
